...
export function getActions(dispatch) {
    return {
        ...
        deletePath: (listKey, detailId, deleteConfirm) => dispatch(ShapeActions.deletePath(listKey, detailId, deleteConfirm)),
        ...
        openPath: (listKey, detailId) => dispatch(ShapeActions.openPath(listKey, detailId)), 
